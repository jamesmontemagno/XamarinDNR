...
namespace DNR.Win.Data
{
    ...
    public sealed class SampleDataSource
    {
        ...
        private void LoadSampleData()
        {
            ...
            for (int i = 0; i < 7; i++)
            {
                group1.Items.Add(new SampleDataItem("Group-1-Item-" + i.ToString(),
                    podcasts[i].Name,
                    "",
                    podcasts[i].Image,
        ...
        public SampleDataSource()
        {
            ...
            group1 = new SampleDataGroup("Group-1", ".NET Rocks!", "", "Assets/DarkGray.png", "");
            this.AllGroups.Add(group1);
        }
        ...
        async void GetEpisodes()
        {
            ...
            {
                episode.Image = "Assets/dnr_logo.jpg";
                group1.Items.Add(new SampleDataItem("Group-1-Item-" + i++.ToString(),
                    episode.Name,"",episode.Image,episode.Description,episode.Description, group1, episode));
            }
